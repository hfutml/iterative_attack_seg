...
def parse_opt():
    ...
    parser.add_argument('--input_att_dir', type=str, default='"/data/home/wangyouze/dataset/VIST-E/resnet_features/conv',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_tgt10_label1.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_src_h5', type=str, default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_src10_label1.h5',
                        help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_adj_h5', type=str, default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_adj10_label1.h5',
                        help='path to the h5file containing the preprocessed dataset')
...
def add_eval_sample_opts(parser):
    ...
    parser.add_argument('--max_length', type=int, default=42,
