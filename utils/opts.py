...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default="/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_res10.json",
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_text_json', type=str,
                        default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_four10.json',
                        help='path to the json file containing additional info and vocab')


    parser.add_argument('--infos_path', type=str, default="/data/home/wangyouze/projects/others/MMT/log/VIST-E/log_5/infos_5-best.pkl",
                    help='path to infos to evaluate')
    parser.add_argument('--model', type=str, default="/data/home/wangyouze/projects/others/MMT/log/VIST-E/log_5/model-best.pth",
                        help='path to model to evaluate')

    parser.add_argument('--input_fc_dir', type=str, default='/data/home/wangyouze/dataset/VIST-E/resnet_features/fc/"',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_conv_dir', type=str, default='/data/home/wangyouze/dataset/VIST-E/resnet_features/conv',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_tgt10_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_src_h5', type=str, default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_src10_label.h5',
                        help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_adj_h5', type=str, default='/data/home/wangyouze/projects/others/MMT/data/VIST-E/data_adj10_label.h5',
                        help='path to the h5file containing the preprocessed dataset')
    ...
    # args.input_json = './data/' + args.dataset + '/data_res10.json'
    
    # args.input_fc_dir = "/data/home/wangyouze/dataset/VIST-E/resnet_features/fc/"
    # # args.input_conv_dir = './data/' + args.dataset + '/image_features'
    # args.input_conv_dir = "/data/home/wangyouze/dataset/VIST-E/resnet_features/conv/"
    # args.conv_ext = '.npz' if args.dataset == 'VIST-E' else '.npy'
    # args.input_box_dir = ''
    # args.input_label_h5 = './data/' + args.dataset + '/data_tgt10_label.h5'
    # args.input_src_h5 = './data/' + args.dataset + '/data_src10_label.h5'
    # args.input_adj_h5 = './data/' + args.dataset + '/data_adj10_label.h5'
    args.enc_emb_path = './data/' + args.dataset + '/embedding/embedding_enc.pt'
    args.dec_emb_path = "/data/home/wangyouze/projects/others/MMT/data/" + args.dataset + '/embedding/embedding_dec.pt'
